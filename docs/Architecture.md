...
### Backend Project Configuration (WebSLT_Backend)
```
Project Name: WebSLT_Backend
Location: ~\AppDev\Projects\Visear\webSLT
Group ID: be.tinvision
Artifact ID: web_slt_backend
...
### Backend Project Structure (WebSLT_Backend)
```
webSLT/
